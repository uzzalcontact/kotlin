...
public abstract interface Base /* Base*/ {
  @Ann(x = 1, y = "134", z = String::class, e = arrayOf(Int::class, Double::class), depr = DeprecationLevel.WARNING, t = @Ann(1, "134", String::class, arrayOf(Int::class, Double::class), DeprecationLevel.WARNING, SimpleAnn("243"), SimpleAnn("4324")))
  public abstract void foo(@Ann(x = 2, y = "324", z = Ann::class, e = arrayOf(Byte::class, Base::class), depr = DeprecationLevel.WARNING, t = @Ann(2, "324", Ann::class, arrayOf(Byte::class, Base::class), DeprecationLevel.WARNING, SimpleAnn("687"), SimpleAnn("78"))) @org.jetbrains.annotations.NotNull() java.lang.String);
